...
def create_app(test_config=None):
   ...
   # set pagination
    ...
    # Create a new question instance
       try:
            question = Question(question=new_question, answer=new_question_answer,
                                category=question_category, difficulty=question_difficulty)
            question.insert()
    ...
    # return successful response
            ...
            return jsonify({
                ...
                'current_total_questions': len(Question.query.all())
            })
        except:
            abort(422)
